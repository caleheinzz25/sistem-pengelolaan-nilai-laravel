...
return [
    ...
    'title' => 'Sistem Pengelolaan Nilai API Documentation',

    // A short description of your API. Will be included in the docs webpage, Postman collection and OpenAPI spec.
    'description' => 'API untuk Sistem Pengelolaan Nilai Siswa berbasis Laravel 13.',
...
INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'Login terlebih dahulu dengan <code>POST /api/login</code> untuk mendapatkan session cookie. Sertakan cookie tersebut pada request berikutnya.',
    ],
